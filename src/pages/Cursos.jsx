        ...
        <section className={`${panelBaseClass} !bg-white overflow-hidden p-0`}>
          <div className="overflow-x-auto">
            <div className="space-y-4 p-4 2xl:hidden">
              {error ? (
                <div className="px-2 py-6 text-sm text-rose-600">Error al cargar los cursos.</div>
              ) : loading ? (
                <div className="px-2 py-6 text-sm text-slate-500">Cargando cursos...</div>
              ) : filtrados.length > 0 ? (
                filtrados.map((item) => (
                  <article
                  ...
                  >
                    ...
                    <div className="mt-4 grid gap-3 sm:grid-cols-2">
                      <div>
                        <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-400">Duracion</p>
                        <p className="mt-1 text-sm text-slate-600">{item.duration} meses</p>
                      </div>
                      <div>
                        <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-400">Horas requeridas</p>
                        <p className="mt-1 text-sm text-slate-600">{item.required_service_hours} horas</p>
                      </div>
                    </div>
                ...
                <div className="px-2 py-6 text-sm text-slate-500">No hay cursos para mostrar.</div>
              )}
            </div>

            <div className="hidden min-w-[980px] 2xl:block">
