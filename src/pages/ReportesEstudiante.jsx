    ...
    <PageShell>
      <div className="mx-auto max-w-7xl space-y-6 p-6">
        ...
        {!loading && !error ? (
          <>
            {/* Vista Tabla */}
            <section className={`hidden ${panelBaseClass} overflow-x-auto !bg-white !p-0 md:block`}>
                  ...
                  {reportesVisibles.map((reporte) => (
                    ...
                    >
                      ...
                      <div className="mt-4 flex flex-col gap-2">
                        ...
                        {reporte.status === "PENDING" ? (
                          <button
                            className="w-full inline-flex items-center justify-center rounded-full border border-slate-200 bg-white px-4 py-2 text-xs font-semibold text-slate-600 transition hover:border-slate-300 hover:bg-slate-50"
                            onClick={(evento) => {
                              evento.stopPropagation();
                              setReporteEditando(reporte);
                            }}
